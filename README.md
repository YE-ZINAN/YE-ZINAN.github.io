...
- 🌱 Heterogenous-agent model via python
  -   Airagari 1994 with endogenous grids: [note_ss.py]([Heterogenous-agent model via Python/note_ss.py](https://github.com/YE-ZINAN/YE-ZINAN.github.io/edit/main/README.md))
